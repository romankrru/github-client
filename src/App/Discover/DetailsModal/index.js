...
const DetailsModal = (props: {|close: Function, data: TRepo|}) => (
	<Modal open onClose={props.close} size="small">
		...
		<Modal.Content>
			...
			<Table>
				<Table.Body>
					...
					<Table.Row>
						...
						<Table.Cell>
							{props.data.stargazers.totalCount}
						</Table.Cell>
					</Table.Row>
					...
					<Table.Row>
						...
						<Table.Cell>
							{moment(props.data.updatedAt).format(
			...
			<a href={props.data.url} target="_blank" rel="noopener noreferrer">
				View source on Github <Icon name="external" />
			</a>
		</Modal.Content>
